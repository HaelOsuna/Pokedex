...
.type {
    ...
    .detail-view {
        ...
        position: relative;
        max-width: 510px;
        background-color: rgb(164, 253, 241);
        border-radius: 5px;
        box-shadow: 0 15px 30px rgb(195, 167, 248),
                    0 20px 25px rgb(33, 1, 51);
      ...
      .image {
          ...
          border-radius: 50%;
          overflow: hidden;
          box-shadow: 0 15px 30px rgb(12, 179, 137),
                      0 10px 10px rgb(49, 5, 129);
        }
